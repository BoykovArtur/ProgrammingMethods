...
Целостность груза и склада | Робот уронил стеллаж с грузом из-за ошибки позиционирования, неисправности захвата или столкновения. | Высокий | Прямые финансовые потери от порчи товара и инфраструктуры, простой склада.
Сохранность груза (с точки зрения инвентаризации) | Система ошиблась: робот привез не тот стеллаж, или сотрудник положил товар не на тот стеллаж (из-за неверной подсказки системы). | Высокий | Нарушение учета, потеря товара, срыв отгрузки клиенту.
...
![Базовый функциональный сценарий](Images/Диаграмма_функциональных_сценариев.png)
